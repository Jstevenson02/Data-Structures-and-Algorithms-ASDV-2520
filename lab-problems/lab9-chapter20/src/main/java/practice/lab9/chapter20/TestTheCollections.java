...
public class TestTheCollections {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("The output for list8 is [white, black, green, blue]. \n"
                ...
                + "shallow copy: only the references of the elements from the sourcel ist are copied.");
        ...
        /* Disjoint(collection1, collection2) method returns true if the two collections have no 
        elements in common. For example, in the following code,disjoint(collection1, collection2) 
        returns false, but disjoint(collection1, collection2( returns true. */
